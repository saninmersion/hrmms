...
class FormPreviewTransformer extends TransformerAbstract
{
    ...
    public function transform(Applicant $applicant): array
    {
        return [
            ...
            'is_editable'  => $applicant->is_editable ?? true,
            ...
            'application' => [
                ...
                'created_date'    => $applicant->created_date_formatted ?? '',
                'last_date'       => $applicant->last_date_formatted ?? '',
                'remaining_days'  => $applicant->remaining_days ?? '',
                'submission_date' => $applicant->application->application_date_formatted ?? '',
            ],
