...
/**
 * Class ApplicantListCriteria
 * @package App\Domain\Users\Criteria
 */
class ApplicantListCriteria extends RequestCriteria
{
    /**
     * @param Builder     $model
    ...
    public function postQuery($model, array $filter)
    {
        ...
        if ( $currentUser->role === AuthRoles::DISTRICT_STAFFS ) {
            $district = $currentUser->district_code;

            $this->districtFilter($model, (string) $district);
        }
