...
/**
 * Class EnumeratorMonitoringFormApiRequest
 *
 * @package App\Application\Api\Requests
 */
class EnumeratorMonitoringFormApiRequest extends ApiRequest
{
    ...
    /**
     * EnumeratorMonitoringFormApiRequest constructor.
     *
    ...
    {
        return [
            'district_code'     => trans('application.district'),
            'municipality_code' => trans('application.local_level'),
            'ward'              => trans('application.ward'),
            'census_area'       => trans('application.census_office'),
    ...
    public function setEnumeratorForm()
    {
        ...
        $this->data = [
            ...
            'monitoring_date'   => now(),
            'district_code'     => $this->input('district_code'),
            'municipality_code' => $this->input('municipality_code'),
