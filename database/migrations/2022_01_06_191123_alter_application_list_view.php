...
/**
 * Class AlterApplicationListView
 */
class AlterApplicationListView extends Migration
{
    /**
     * Run the migrations.
     *
...
select aa.id
     ...
     , cd.code                                                                                           as citizenship_issued_district_code
...
_SQL_;
    ...
    protected function dropView()
    {
        ...
        DB::statement("drop materialized view if exists {$viewName} CASCADE;");
    }
}
