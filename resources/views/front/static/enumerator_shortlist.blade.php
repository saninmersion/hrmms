@section('title', config('app.name_ne') . 'को लागि सर्टलिष्ट भएका गणकहरुको नामावली')
<x-front-layout>
        ...
        <div class="container">
            <div class="md:w-3/4 mx-auto px-2">
                ...
                <h1 class="heading-primary  !text-primary heading-primary--lg py-6 sm:py-8 lg:pt-10">
                    {{config('app.name_ne')}} को लागि सर्टलिष्ट भएका गणकहरुको नामावली
                </h1>
                ...
                <section class="!pt-0 sm:!pt-2">
                    <div class="grid sm:grid-cols-2">
                        @foreach ($districts as $district)
                            <a href="{{App\Infrastructure\Support\Helper::fileUrl(sprintf('results/enumerator/%s.pdf', str_replace([' ', '(', ')'], ['-', '', ''], $district['title_en'])))}}"
                               target="_blank"
