<template>
    <div class="card mt-8 mb-4 card-js-scroll card-qualification">
            ...
            <div v-if="qualification.has_education_qualification">
                    ...
                    <div class="mt-8">
                        <div class="grid lg:grid-cols-2 gap-6">
                            <div class="grid sm:grid-cols-2 gap-4">
                                ...
                                <div>
                                    <div v-if="getFromObject(qualification, 'education.supervisor.grading_system') === 'percentage'">
                                        <label-component>
                                    ...
                                    <div v-if="getFromObject(qualification, 'education.supervisor.grading_system') === 'grade'">
                                        <label-component>
                            ...
                            <div class="grid sm:grid-cols-2 gap-3">
                                ...
                                <div>
                                    <div v-if="getFromObject(qualification, 'education.supervisor.major_subject') === 'others'">
                ...
                <fieldset v-if="enumeratorSelected">
                    ...
                    <div class="grid md:grid-cols-2 gap-4 mt-8">
                        <div class="grid sm:grid-cols-2 gap-6">
                            ...
                            <div>
                                <div v-if="getFromObject(qualification, 'education.enumerator.grading_system') === 'percentage'">
                                    <label-component>
                                        {{ trans("application.fields.percentage") }}
                                    </label-component>
                                ...
                                <div v-if="getFromObject(qualification, 'education.enumerator.grading_system') === 'grade'">
                                    <label-component>
                ...
                <div class="my-6">
                    <div class="pb-2">
                        ...
                        <span class="text-base-3">({{ trans("general.optional") }})</span>
                    </div>
                    ...
                    <div class="grid md:grid-cols-2 gap-6 mt-6">
                        <div class="grid md:grid-cols-2 gap-3">
                            ...
                            <div>
                                <div v-if="getFromObject(qualification, 'education.extra.major_subject') === 'others'">
                                    <label-component :value="trans('application.fields.major_subject_other')"/>
        ...
        <div class="my-6">
            ...
            <fieldset v-if="qualification.has_training">
                ...
                <div class="input-file grid md:grid-cols-2 gap-6">
                    <div>
                        <label-component class="mt-2" :value="trans('application.fields.training_document')"/>
                        <div class="relative">
                            <div class="text-base-3">
                                {{ trans("application.form-help-text.image-format-size") }}
                            </div>
            ...
            <fieldset v-if="qualification.has_experience">
                ...
                <div class=" input-file grid md:grid-cols-2 gap-6 ">
                    <div>
                        ...
                        <div class="relative">
                            <span class="text-base-3">{{ trans("application.form-help-text.image-format-size") }}</span>
