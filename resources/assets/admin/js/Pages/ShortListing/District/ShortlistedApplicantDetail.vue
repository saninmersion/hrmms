<template>
    <admin-layout :authorized="isAuthorized($page, 'district_shortlisting')"
                  :back-url="route('admin.shortlisting.index')"
                  page-title="Shortlisted Applicant Detail">
        <template #breadcrumb>
            <bread-crumb>
...
<script>
    ...
    import ApplicantPersonal   from "./Partials/ApplicantPersonal"
    import ApplicantPosition   from "./Partials/ApplicantPosition"
    import ApplicantSubmission from "./Partials/ApplicantSubmission"
