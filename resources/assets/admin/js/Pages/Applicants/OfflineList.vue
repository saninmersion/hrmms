<template>
    <admin-layout page-title="Applications" :authorized="isAuthorized($page, 'offline_index')">
        <template #breadcrumb>
            <bread-crumb>
                <bread-crumb-item :href="route('admin.applications.offline.index')" label="Applications"/>
        ...
        <data-table :pagination="pagination"
            ...
            <template #tbody="{row: applicant}">
                <table-body-col no-wrap>
                    ...
                    <p class="whitespace-nowrap text-xs text-base-3" v-text="formatDob(applicant.dob)"/>
                </table-body-col>
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        methods: {
            loadData(query) {
                this.$inertia.visit(this.route("admin.applications.offline.index"), {
                    method: "get",
                    data: query,
                    preserveState: true,
                    preserveScroll: true,
            ...
            handleRowClick(applicant) {
                this.$inertia.visit(this.route("admin.applications.offline-form.show", applicant.id))
            },
        },
    }
</script>
