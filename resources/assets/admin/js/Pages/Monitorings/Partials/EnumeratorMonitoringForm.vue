<template>
    <form id="enumerator-monitoring-form"
          class="form"
...
<script>
    ...
    import EnumeratorOnsiteMonitoring from "./EnumeratorOnsiteMonitoring"

    export default {
        name: "EnumeratorMonitoringForm",
        components: { EnumeratorOnsiteMonitoring, ActionMessage, PrimaryButton, CancelButton, DropDownInput, InputError, LabelComponent, RadioGroupInput, InputComponent },
        props: {
