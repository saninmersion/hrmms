<template>
    <admin-layout page-title="Supervisor Monitoring Form" :authorized="isAuthorized($page, 'monitoring_supervisor')">
        <form id="supervisor-monitoring-form"
              class="form"
...
<script>
    ...
    import SupervisorOnsiteFamilyMonitoring from "./Partials/SupervisorOnsiteFamilyMonitoring"
    import SupervisorOnsiteHouseMonitoring  from "./Partials/SupervisorOnsiteHouseMonitoring"

    const OPERATOR = "operators"

    export default {
        name: "SupervisorMonitoringFormAdd",
        components: { SupervisorOnsiteFamilyMonitoring, SupervisorOnsiteHouseMonitoring, RadioGroupInput, InputComponent, DropDownInput, InputError, LabelComponent, ActionMessage, CancelButton, PrimaryButton, AdminLayout },
        props: {
        ...
        methods: {
            ...
            submitForm() {
                this.form.post(this.route("admin.monitorings.form.supervisor.store"))
            },
        },
    }
</script>
