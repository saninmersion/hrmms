    ...
    <Fragment>
        <div class="input-file">
            <div class="flex items-center flex-wrap gap-4 lg:gap-16 mt-2">
                <div class="input-file flex flex-col sm:flex-row flex-wrap gap-2 sm:gap-0 lg:flex-row w-full gap-4 py-2 pb-4 bg-blue-100 rounded-md">
                    <div class="input-file-btn sm:w-1/2 flex flex-col items-center cursor-pointer" @click="openCameraModal">
                        <span class="block my-2 text-black-200" v-text="trans('general.take_photo')"/>
                    ...
                    <div class="input-file-btn sm:w-1/2 flex flex-col items-center relative pt-4 sm:pt-0">
                        <span class="block my-2 text-black-200" v-text="trans('general.browse_photo')"/>
                        <div class="input-file-box  h-16 w-16  flex flex cursor-pointer">
                            ...
                            <input ref="fileInput"
                                   ...
                                   type="file"
                                   class="btn-remove--absolute top-0 right-0 h-full cursor-pointer w-full"
